...
$req = <<<EOT
SELECT p.idPost, p.creationDate AS creaDate, p.modificationDate AS modifDate, p.commentaire AS comment,
...
GROUP BY p.idPost
UNION
SELECT p.idPost, p.creationDate, p.modificationDate, p.commentaire,
null AS medias,
null AS types
FROM post AS p
